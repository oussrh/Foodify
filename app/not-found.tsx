...
/**
 * An address nothing answers, or a portal page's `notFound()`: rendered in the root layout, above
 * every segment's theme scope, so it mounts the staff one itself (the menu has its own not-found).
 */

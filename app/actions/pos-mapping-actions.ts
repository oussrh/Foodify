...
// admin acting for them (logged as such), POS on (`requirePosAccess`).
'use server'
...
/** The restaurant's owner or a super admin, POS on. Answers the POS's items and every active dish with its suggested and current match. */

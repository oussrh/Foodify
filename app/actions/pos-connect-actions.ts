...
// for them (logged as such) (`requireRestaurantAccess`). Each answers an outcome the tab shows as it is; the work is server/pos/.
'use server'
...
/**
 * The restaurant's owner or a super admin. Parses `posConnectInput` and signs the restaurant in to that POS: the POS checks

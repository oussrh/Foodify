...
import { ArrowLeft, Utensils, Settings, ChefHat, BarChart3, Shield } from 'lucide-react'
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="border-b border-gray-200 pb-6">
        <div className="flex items-center gap-4 mb-4">
          <Button variant="ghost" size="sm" asChild className="hover:bg-red-50">
            <Link href={`/admin/restaurants/${dish.restaurantId}/dishes`}>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-bold tracking-tight text-gray-900 mb-2">Admin Dish Editor</h1>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Full administrative control with deletion capabilities
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-8 xl:grid-cols-3">
        ...
        {/* Right Column - Ingredients & Admin Actions */}
        <div className="space-y-8">
          <Card className="border-0 shadow-lg">

...
import { bareResponse, rowReturn, unboundedList } from './abatty-probes/api.mjs'
...
export const probes = [unparsedBoundary, wholeEnv, serverCacheUse, unguardedAdminPage, bareResponse, unboundedList, rowReturn]

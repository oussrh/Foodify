...
export const MENU_TEXT = {
  en: {
    ...
    tabClosed: 'That table’s order can no longer be added to. Send this as a new order.',
    orderRejected: 'Something in the order was not accepted. Check the table number and any notes, then try again.',
  ...
  fr: {
    ...
    tabClosed: 'La commande de cette table ne peut plus être complétée. Envoyez-la comme nouvelle commande.',
    orderRejected: 'Un élément de la commande a été refusé. Vérifiez le numéro de table et les notes, puis réessayez.',

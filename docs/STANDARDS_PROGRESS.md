...
| Coverage `lib/**` statements / branches / functions / lines | - | 92.7 / 79.7 / 79.4 / 92.9 (per file: `menu.ts` 88.8 / 85 / 63.6 / 86.2, `totp.ts` 100) | raised, never lowered | `vitest` thresholds, total and changed lines | TEST.4 |

...
// The board's two lanes: what is waiting to be started, and what is being made. An order moves
...
const LANES: Lane[] = [
  ...
  { status: 'ACCEPTED', title: 'Being made', empty: 'Nothing on yet.', accent: 'bg-success' },
]

...
export function AdminRestaurantActions({ restaurantId, restaurantName }: AdminRestaurantActionsProps) {
          ...
          <div className="p-3 bg-red-50 border border-red-200 rounded-lg">
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-red-700">
                <strong>Warning:</strong> This action cannot be undone. All restaurant data including menus, dishes, users, and customer data will be permanently removed.
              </div>
            </div>
          </div>
        </AlertDialogDescription>
